...
namee = Label(win,text='Group 2', font=('Verdana',14,'bold'),relief=GROOVE,width = 22,bd=5, fg="#F5EAEA", bg="#20262E")
namee.place(x=1200,y=650)
rollno = Label(win,text='AccessSign', font=('Verdana',14,'bold'),relief=GROOVE,width = 22,bd=5, fg="#F5EAEA", bg="#20262E")
